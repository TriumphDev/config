package me.mattstudios.config.beanmapper.leafvaluehandler;
...
public interface LeafValueHandler {
     ...
     * when {@link Property#toExportValue} is called on a bean property.
     * Returns null if the leaf value handler cannot handle the value.
     * <p>
     * Return {@link MapperImpl#RETURN_NULL} to signal that null should be used
